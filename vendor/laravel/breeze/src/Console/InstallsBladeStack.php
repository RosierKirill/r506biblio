...
trait InstallsBladeStack
{
    ...
    protected function installBladeStack()
    {
        ...
        // "Dashboard" Route...
        $this->replaceInFile('/home', '/tableau_de_bord', resource_path('views/welcome.blade.php'));
        $this->replaceInFile('Home', 'Dashboard', resource_path('views/welcome.blade.php'));
        $this->replaceInFile('/home', '/tableau_de_bord', app_path('Providers/RouteServiceProvider.php'));
